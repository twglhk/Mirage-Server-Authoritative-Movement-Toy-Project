...
namespace WardGames.John.AuthoritativeMovement
{
    public class TestNetworkMover : NetworkBehaviour
    {
        ...
        /// <summary>
        /// Owner client of object process result of move simulation from server.
        /// </summary>
        /// <param name="reader"></param>
        [Client]
        private void OwnerClientProcessRecvServerMoveInfo(NetworkReader reader)
        {
        ...
        public override void OnDeserialize(NetworkReader reader, bool initialState)
        {
            ...
            _lastRecvTime = Time.time;
            OwnerClientProcessRecvServerMoveInfo(reader);
        }
